...
\begin{document}
	...
	\begin{itemize} \item New project members: This document can be a guide for a
		...
		the relevant modules they are searching for. \item Maintainers: The hierarchical
		structure of the module guide improves the maintainers' understanding when they
		need to make changes to the system. It is important for a maintainer to update
		the relevant sections of the document after changes have been made. \item
		Designers: Once the module guide has been written, it can be used to check for
		...
		decomposition, and flexibility of the design. \end{itemize}
	...
	\begin{description} \item[\refstepcounter{ucnum} \uctheucnum \label{ucIO}:]
		...
		Screen). \item[\refstepcounter{ucnum} \actheacnum \label{acForm}:] Nonlocal
	...
	\begin{description} \item [\refstepcounter{mnum} \mthemnum \label{mHH}:]
		...
		\item [\refstepcounter{mnum} \mthemnum \label{mFD}:] Frequency Domain PDE Solver
		Module.
