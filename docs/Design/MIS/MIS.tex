...
\section{MIS of \progname{} Control Module} \label{Module} \wss{Use labels for
  cross-referencing}
...
%
%
\section{MIS of Input Parameter Module} \label{ICM} \wss{Use labels for
	cross-referencing}
...
%
%
\section{MIS of Specific Parameters Module} \label{SPM} \wss{Use labels for
	cross-referencing}
...
%
%
\section{MIS of Frequency Domain PDE Solver Module:} \label{GRM} \wss{Use labels for
	cross-referencing}
